...
contract RewarderMock is IRewarder {
    ...
    function onPichiReward (uint256, address user, address to, uint256 pichiAmount, uint256) onlyMCV2 override external {
    ...
    function pendingTokens(uint256 pid, address user, uint256 pichiAmount) override external view returns (IERC20[] memory rewardTokens, uint256[] memory rewardAmounts) {
