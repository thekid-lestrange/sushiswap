...
contract KushoPairMediumRiskV1 is ERC20, BoringOwnable, IMasterContract {
    ...
    function name() external view returns (string memory) {
        return string(abi.encodePacked("Kusho Medium Risk ", collateral.safeName(), "/", asset.safeName(), "-", oracle.name(oracleData)));
    }
    ...
    // Settings for the Medium Risk KushoPair
    ...
    function init(bytes calldata data) public payable override {
        ...
        require(address(collateral) != address(0), "KushoPair: bad pair");
    ...
    function liquidate(
        ...
        require(allBorrowAmount != 0, "KushoPair: all are solvent");
