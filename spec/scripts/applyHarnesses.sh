...
# Adding virtual to pichiPerBlock()
perl -0777 -i -pe 's/function pichiPerBlock\(\) public view returns/function pichiPerBlock\(\) public view virtual returns/g' contracts/MasterChefV2.sol
