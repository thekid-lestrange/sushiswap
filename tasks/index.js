...
task("polyscan", "Verify deployed contract with etherscan", require("./verify"))
...
task("maker:serve", "PolyCityHall serve")
  ...
  .setAction(async function ({
    ...
    await (await maker.connect(await getNamedSigner("dev")).convert(a, b, {
      gasLimitgasLimit: 5198000
    })).wait()
  });